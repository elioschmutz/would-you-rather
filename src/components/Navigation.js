        ...
        <div className="collapse navbar-collapse" id="main-navigation">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
              <Link to="/" className="nav-link"><FaIconHome /> Overview</Link>
            </li>
            <li className="nav-item">
              <Link to="/add" className="nav-link"><FaIconPlus /> Add question</Link>
            </li>
            <li className="nav-item">
              <Link to="/leaderboard" className="nav-link"><FaListOl /> Leaderboard</Link>
            </li>
          </ul>
          <ul className="navbar-nav">
            <li className="nav-item dropdown">
              ...
              >
                <Link to="/logout" className="dropdown-item"><FaAngleLeft /> Logout</Link>
              </div>
            </li>
          </ul>
        </div>
